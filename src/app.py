...
# เพิ่ม Middleware สำหรับตรวจสอบสิทธิ์ Admin โดยเฉพาะ
...
# --- 5. Admin Routes (User เข้าไม่ได้) ---
@app.route('/admin_dashboard')
@login_required
@admin_required # ป้องกัน User แอบเข้าผ่าน URL
def admin_dashboard(): 
    return render_template('admin_dashboard.html', users=User.query.all())

@app.route('/register_page')
@login_required
@admin_required # ป้องกัน User แอบเข้า
def register_page(): 
